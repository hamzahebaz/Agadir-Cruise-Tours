...
<body>
          ...
          <div class="detail-block">
            ...
            <div class="tour-gallery-layout">
              <div class="tour-gallery-featured" id="gallery-featured">
                <img src="../../${activity.image}" alt="${activity.title} Featured" id="featured-main-img">
  ...
  <script type="text/javascript">
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const activityImages = ${JSON.stringify(images)};
      const imagesList = activityImages.map(img => '../../' + img);
